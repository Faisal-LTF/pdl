...
<template>
    <div
        ...
        <div class="flex flex-col items-center justify-center">
            <div
                style="border-radius: 56px; padding: 0.3rem; background: linear-gradient(180deg, var(--primary-color) 10%, rgba(33, 1520, 243, 05) 30%)">
                <div class="w-full bg-surface-0 dark:bg-surface-150 py-20 px-8 sm:px-20" style="border-radius: 53px">
                    <div class="text-center mb-8">
                        ...
                        <div class="text-black text-3xl font-medium mb-4">Welcome to
                            PrimeLand!</div>
